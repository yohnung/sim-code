...
// Grid Number
const int Grid_Num_x=7;     // VS run, maximum value is 13
...
const double rho_m_0=5.;            // 1.
const double rho_s_0=5.;            // 1.
const double width_rho=1.3;         // 1.
const double B_m_0=2.5;             // 1.
const double B_s_0=2.5;             // 1.
const double v_0=3.3;               // 0.
const double vyi_0=2.7;             // 0.
const double di=4.7;                // 0.  what's its meaning???????? used in current amendation and V_cross_B in flux calculation
